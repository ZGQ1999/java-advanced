...
public class Date {
    public static void main (String[] args) {
        ...
        int year = today2.getYear();
        int month = today2.getMonthValue();
        int day = today2.getDayOfMonth();
        System.out.printf("Year : %d  Month : %d  day : %d t %n", year, month, day);
        //3.在Java 8中处理特定日期
        LocalDate dateOfBirth = LocalDate.of(2000, 10, 01);
        System.out.println("Your Date of birth is : " + dateOfBirth);
        //4.在Java 8中判断两个日期是否相等
        LocalDate date1 = LocalDate.of(2014, 01, 14);
        if (date1.equals(today)) {
            System.out.printf("Today %s and date1 %s are same date %n", today, date1);
        }
        //5.在Java 8中检查像生日这种周期性事件
        ...
        if (currentMonthDay.equals(birthday)) {
            ...
            LocalTime newTime = time1.plusHours(3); // adding two hours
