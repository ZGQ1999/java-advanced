...
public class BoxLayoutTest extends JFrame {
    ...
    public void  init(){
        ...
        //topPanel设置背景色和合适的大小
        topPanel.setBackground(new Color(255,227,132));
        topPanel.setPreferredSize(new Dimension(414,100));

        //左侧按钮
        JButton leftButton = new JButton("点赞");
        ...
        //右侧按钮
        JButton rightButton = new JButton("评论");
        ...
        for (int i = 0;i<3 ;i++){
            ...
            jPanel.setBackground(new Color(255,227,132));
